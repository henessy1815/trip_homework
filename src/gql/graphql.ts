...
export type FetchBoardsWithSearchQuery = { fetchBoardsCount: number, fetchBoards: Array<{ _id: string, writer: string | null, title: string, createdAt: string }> };
...
export type FetchTravelproductsQuery = { fetchTravelproducts: Array<{ _id: string, name: string, remarks: string, price: number | null, tags: Array<string> | null, images: Array<string> | null, pickedCount: number | null, seller: { _id: string, name: string } | null }> };
